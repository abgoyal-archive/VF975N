...
static struct resource mt_resource_sd0[] = {
    {
        .start  = MSDC_0_BASE,
...
static struct resource mt_resource_sd1[] = {
    {
        .start  = MSDC_1_BASE,
...
static struct resource mt_resource_sd2[] = {
    {
        .start  = MSDC_2_BASE,
...
static struct resource mt_resource_sd3[] = {
    {
        .start  = MSDC_3_BASE,
...
static struct platform_device mt_device_fb = {
    .name = "mtkfb",
    .id   = 0,
...
static struct resource mt_TVOUT_resource[] = {
    [0] = {//TVC
        .start = TVC_BASE,
        .end   = TVC_BASE + 0x78,
        .flags = IORESOURCE_MEM,
...
static u64 mt_TVOUT_dmamask = ~(u32)0;

static struct platform_device mt_TVOUT_dev = {
	.name		  = "TV-out",
	.id		  = 0,
	.num_resources	  = ARRAY_SIZE(mt_TVOUT_resource),
	.resource	  = mt_TVOUT_resource,
	.dev              = {
		.dma_mask = &mt_TVOUT_dmamask,
		.coherent_dma_mask = 0xffffffffUL
	}
};
#endif
static struct platform_device mt_device_sd[] =
{
#if defined(CFG_DEV_MSDC0)
    {
        .name           = "mtk-sd",
...
/*=======================================================================*/
/* MT66xx RFKill BT */
struct platform_device mt_device_rfkill = {
    .name   = "mt-rfkill",
    .id     = -1,
};
#endif
...
//	{ I2C_BOARD_INFO("mtk-tpd", (0xBA>>1)),},
	{I2C_BOARD_INFO("fan5405", (0xd4>>1)),},			
        ...
        { I2C_BOARD_INFO("pn544", (0x50>>1)), },  //joey for NFC
#endif  
};
...
static struct resource mt_MDP_resource[] = {
...
static u64 mt_MDP_dmamask = ~(u32)0;

static struct platform_device mt_MDP_dev = {
	.name		    = "mt-mdp", /* FIXME. Sync to MHAL and init.rc */
	.id		        = 0,
	.num_resources	= ARRAY_SIZE(mt_MDP_resource),
	.resource	    = mt_MDP_resource,
	.dev            = {
		.dma_mask = &mt_MDP_dmamask,
		.coherent_dma_mask = 0xffffffffUL
	}
};
#endif

static u64 mt_SMI_dmamask = ~(u32)0;

static struct platform_device mt_SMI_dev = {
	.name		  = "mt-smi",
	.id		  = 0,
	.dev              = {
		.dma_mask = &mt_SMI_dmamask,
		.coherent_dma_mask = 0xffffffffUL
	}
};
...
/* MT6577 SYSRAM                                                         */
/*=======================================================================*/
static struct platform_device mt_SYSRAM_dev = {
...
//	i2c_register_board_info(2, i2c_devs2, ARRAY_SIZE(i2c_devs2));
    ...
    for (i = 0; i < ARRAY_SIZE(mt_device_sd); i++){
