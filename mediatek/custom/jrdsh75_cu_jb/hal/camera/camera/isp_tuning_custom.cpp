...
#define DAYLIGHT_F_IDX 50
#define DAYLIGHT_F2_IDX 0
//meimei
...
refine_OB(RAWIspCamInfo const& rCamInfo, ISP_NVRAM_OB_T& rOB)
{
    ...
    case ECamMode_Offline_Capture_Pass1:
        // TODO: Add your code below...
        /*
        rOB.rgboff.bits.OFF00 = 15; // B
        rOB.rgboff.bits.S00 = 1;    // -
        rOB.rgboff.bits.OFF01 = 13; // Gb
        rOB.rgboff.bits.S01 = 1;    // -
        rOB.rgboff.bits.OFF10 = 13; // Gr
        rOB.rgboff.bits.S10 = 1;    // -
        rOB.rgboff.bits.OFF11 = 15; // R
...
//meimei hack
	...
	if (m_i4FluorescentIndex < DAYLIGHT_F_IDX){
           LOGD(
