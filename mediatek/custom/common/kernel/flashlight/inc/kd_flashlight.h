...
#define FLASHLIGHTIOC_X_SET_FLASHLEVEL _IOW(FLASHLIGHT_MAGIC,40,unsigned long)

#define FLASHLIGHT_TORCH_SELECT _IOW(FLASHLIGHT_MAGIC,45,unsigned long)

#define FLASHLIGHTIOC_ENABLE_STATUS _IOR(FLASHLIGHT_MAGIC,50,unsigned long)
