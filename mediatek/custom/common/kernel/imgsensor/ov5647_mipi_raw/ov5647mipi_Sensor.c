...
#define OTP_MID               0x06	//Q-tech module
#define TRACE printk
...
static void OV5647MIPI_Sensor_1M(void)
{
	...
	OV5647MIPI_write_cmos_sensor(0x3820, 0xF9);
...
UINT32 OV5647MIPIOpen(void)
{
	...
	OV5647MIPI_write_cmos_sensor(0x0100, 0x01);//wake up
	mdelay(50);
	otp_update_wb(0x5B,0x5B); // according to golden sample r/g & b/g by Q-Tech
