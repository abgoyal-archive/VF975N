...
--------------------------------------------------------------------------------
|   bma280  |   0xF9    |        14        | 0x18 (SDO: Low)          |           0x19 (SDO: High)    |
***********************************************************************/
/*
 * configuration
*/
#define BMA_DRIVER_VERSION "V1.0"
#define BMA_I2C_ADDRESS(SENSOR_NAME, PIN_STATUS) SENSOR_NAME##_I2C_ADDRESS_##PIN_STATUS

//#define CONFIG_BMA_LOWPASS   /* apply low pass filter on output */		 
